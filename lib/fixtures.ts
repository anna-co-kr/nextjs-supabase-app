...
export const DUMMY_EVENTS: Event[] = [
  {
    ...
    location: "제주도",
    registrationDeadline: "2025-04-20T23:59:00+09:00",
  ...
  },
  {
    ...
    location: "강남구청 수영장",
    registrationDeadline: "2025-04-29T18:00:00+09:00",
...
export const DUMMY_MEMBERS: Record<string, EventMember[]> = {
  e1: [
    ...
    },
    {
      id: "m11",
      eventId: "e1",
      user: { id: "u11", name: "배소희", email: "sohee@example.com" },
      status: "rejected",
      note: "일정 조율 불가로 취소 요청",
      appliedAt: "2025-04-09T10:00:00+09:00",
      rejectedAt: "2025-04-12T14:00:00+09:00",
    },
  ],
};
