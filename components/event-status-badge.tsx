...
const MEMBER_STATUS_MAP: Record<MemberStatus, { label: string; className: string }> = {
  confirmed: { label: "확정", className: "bg-green-100 text-green-700 border-green-200" },
  waiting: { label: "대기", className: "bg-yellow-100 text-yellow-700 border-yellow-200" },
...
const PAYMENT_STATUS_MAP: Record<PaymentStatus, { label: string; className: string }> = {
  paid: { label: "납부완료", className: "bg-green-100 text-green-700 border-green-200" },
  pending: { label: "미납", className: "bg-orange-100 text-orange-700 border-orange-200" },
};
